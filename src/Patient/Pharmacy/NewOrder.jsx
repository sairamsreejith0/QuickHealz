...
import {CloseOutlined, ShoppingCartOutlined, PlusOutlined, MinusOutlined} from '@ant-design/icons';
...
const NewOrder = ({exisistingOrders, changeNewMode}) => {
 ...
 const pharmacyItems = [
  ...
  const renderPharmacyItems = React.useCallback((pharmacyItems) =>{
  ...
  const renderContent = React.useMemo(() => {
    ...
    return (
      <div>
       {renderPharmacyItems(pharmacyItems)}
      </div>
    )
  }, [isOnSummary, pharmacyItems, cartItems, newOrder]);
